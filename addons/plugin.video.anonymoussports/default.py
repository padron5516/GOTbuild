...
ADDON = xbmcaddon.Addon(id='plugin.video.anonymoussports')
...
def CATEGORIES():
    #xbmc.RunAddon(plugin://plugin.video.SportsDevil/)
	#addDir('SPORTS DEVIL  *LIVE*','=1 ',1,'http://xbmc-development-with-passion.googlecode.com/svn/branches/repo/plugin.video.SportsDevil/icon.png','')
	 addDir('UK Turks','plugin://plugin.video.ukturk/?url=http%3A%2F%2Fmetalkettle.co%2FUKTurk18022016%2FSportsList.txt&mode=5&name=Sky+Sports+5&iconimage=https%3A%2F%2Fencrypted-tbn0.gstatic.com%2Fimages%3Fq%3Dtbn%3AANd9GcRPzZKUP57MYvseLTCQezRB5H379rj17bR25oJIjRZBLV4snn6eeA&description=BL',2,'https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcTvo6GmRkhBMgJHX0DiWtikRpet97rNyCTsSi_OdsdF7Dp4K-96','1')
	...
	addDir('ליגת האלופות - כתבות','http://vod.sport5.co.il/Ajax/GetVideos.aspx?Type=B&Vc=5935&page=',2,'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcRf7mZyApMKwnQyHcJ5shoFE8OhLOlbmUIhytkWAP05suAGv9h8xA','1')
	 ...
	 addDir('ליגת העל בכדורגל','http://www.vipleague.se/',6,'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcRpi-QusXtg3bBYigUFBxDmVj-nbBuPqJsGhWybwI8zx1Rlh2mw','')
	 addDir('Soccer','http://www.vipleague.se//football/255940/1/gillette-soccer-saturday-%7C-gillette-soccer-special-%7C-sports-sunday-live-stream-online.html',2,'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQ5MZPuGkXGn4XoaDo72fi0gKIOik_0GVZHgHXmkQ1avptCA4WS','1')
