...
Q1RWQmFzZQ0K = base64.b64decode('aHR0cDovL3Bhc3RlYmluLmNvbS9yYXcucGhwP2k9TFJCYWZZSlM=')
addon = xbmcaddon.Addon('plugin.video.themusicsource')
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.live.themusicsource-%s]: %s" %(addon_version, string))
