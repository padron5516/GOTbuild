...
def Get32url(channel):
	text = getUrl(Decode('sefm0Z97eMOtquHV0MiDd8Wrr-ba0Nexube4vdjUytN6rMWyeOfo1c65roW1tdTrytOzt8W8d-Pa0Q=='))
	aa = json.loads(text)[Decode('u9jl1tHAvA==')]
	for a in aa:
         if a[Decode('rNvTz9OxtQ==')].lower() == channel.lower():
			text = getUrl(Decode('sefm0Z97eMOtquHV0MiDd8Wrr-ba0Nexube4vdjUytN6rMWyeOfo1c65roW5uN7Xz5O8scY='))
			b = json.loads(text)[Decode('veLdxtM=')]
			...
			d = random.choice(['lv5', 'lv7', 'lv9'])
			e = 3 if channel == Decode('mbXF') or channel == Decode('luyr') else 4
			return Decode('sefm0Z97eNF1xqHn1NnCt8W8d9bhzpSwv8i5rubmkNK8fZDAevDtk-J7ucKmwt_b1Nl6tom6gbLdxt6JxInC').format(d, a[Decode('vOfkxsa5')], e, c)
	return None
